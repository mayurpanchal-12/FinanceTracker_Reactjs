...
export default function InsightsPage() {
  ...
  const thisMonthLabel = new Date().toLocaleDateString("en-US", {
    month: "long",
    year: "numeric",
  });
  ...
  if (!mainTransactions.length || !insights) {
    return (
            ...
            <div className="flex items-center gap-3 mt-3">
              ...
              <div>
                ...
                <p className="text-red-500 font-semibold text-sm">
                  ₹{fmt(insights.topCategory[1])} total
                </p>
              </div>
            </div>
          </div>
        ...
        {insights.mostActiveDay && (
          <div className="card px-6 py-5">
            ...
            <div className="flex items-center gap-3 mt-3">
              ...
              <div>
                <p className="text-lg font-bold text-text-main">
                  {insights.mostActiveDay[0]}
                </p>
                <p className="text-text-light text-sm">
                  {insights.mostActiveDay[1]} transactions
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center gap-3 mt-3">
              ...
              <div>
                <p className="text-lg font-bold text-red-500">
                  ₹{fmt(insights.biggestExpense.amount)}
                </p>
                <p className="text-text-light text-sm">
            ...
            <div className="flex items-center gap-3 mt-3">
              ...
              <div>
                <p className="text-lg font-bold text-emerald-600">
                  ₹{fmt(insights.biggestIncome.amount)}
                </p>
                <p className="text-text-light text-sm">
                  {insights.biggestIncome.category} ·{" "}
                  {insights.biggestIncome.date}
                </p>
        ...
        <div className="card px-6 py-5">
          ...
          <div className="space-y-2 mt-3">
            ...
            <div className="flex justify-between">
              ...
              <span
                className={`font-extrabold ${insights.totalIncome - insights.totalExpense >= 0 ? "text-emerald-600" : "text-red-500"}`}
              >

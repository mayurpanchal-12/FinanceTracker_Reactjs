      ...
      <section className="card notes-section animate-fade-in">
        <div className="notes-header">
          ...
          <p className="notes-header__subtitle">
            Notes you added while creating transactions — reminders and extra
            context.
          </p>
        </div>
        ...
        {notes.length === 0 ? (
          <div className="notes-empty">
            ...
            <p className="notes-empty__text">
              No notes yet. Add one from the Tracker form.
            </p>
          </div>
        ) : (
          <ul className="notes-grid">
            {notes.map((tx) => (
              <li key={tx.id} className="note-card group">
                <div
                  className={`note-card__accent ${tx.type === "income" ? "note-card__accent--income" : "note-card__accent--expense"}`}
                />
                ...
                <div className="note-card__inner">
                  ...
                  <div className="note-card__top-row">
                    <span
                      className={`note-card__badge ${tx.type === "income" ? "note-card__badge--income" : "note-card__badge--expense"}`}
                    >
                      {tx.type}
                    </span>
                  ...
                  <div className="note-card__details">
                    {[
                      ...
                      <div key={k} className="note-card__detail-row">
                        ...
                        <span className="note-card__detail-value" title={v}>
                          {v}
                        </span>
                      </div>
                    ))}

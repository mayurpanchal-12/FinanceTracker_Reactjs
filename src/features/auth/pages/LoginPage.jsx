  ...
  const handleEmailAuth = async (e) => {
    ...
    try {
      if (isRegister) {
        ...
        await signOut(auth);
        setSuccess(
          'Account created! Check your inbox — if you don\'t see it, check your spam/junk folder and mark it as "Not Spam".',
        );
        setIsRegister(false);
        return;
      } else {
        ...
        <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-xl border border-white/80 px-8 py-10">
          <div className="flex flex-col items-center mb-8">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-2xl font-bold text-primary opacity-60">
                ₹
              </span>

    ...
    <>
      ...
      <div className="card px-5 py-3 my-2 flex items-center gap-2 border-l-4 border-l-primary/50">
        ...
        <p className="text-xs text-text-light font-medium">
          Budgets are <strong className="text-text-main">monthly</strong> — they
          reset automatically each month. Set a limit per category and we'll
          warn you when you're close or over.
        </p>
      </div>
